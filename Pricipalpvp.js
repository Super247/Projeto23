import FuncoesDado from "./dadopvp";
...
const npc = new Entidades.Entidade("Drax",1,100);
npc.falar("OLá")

const player1 = new Entidades.Player("Ghost",10,100,1000,10,10);

const pocao_cura= new Pocoes("Poção de cura Grande",2,"Vida",20);
const pocao_forca=new Pocoes("Poção de força",1,"força",10);

const espada1=new Armas("Espada lendário",10,50,"espada",)
